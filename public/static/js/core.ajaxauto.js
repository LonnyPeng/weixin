...
$.fn.ajaxJson = function(json) {
    ...
    var redirect = function() {
        ...
        if (json.redirect == 'reload') {
            ...
            window.location.href = window.location.origin + '/' + json.redirect;
        }
    };
...
$.fn.ajaxLink = function(settings) {
    ...
    this.each(function() {
        ...
        var context = $(this);
        var disableContext = function(){context.attr('disabled', 'disabled').removeClass('primary');};
        var enableContext = function(){context.removeAttr('disabled', 'disabled').addClass('primary');};
        if(url !== undefined) {
            settings.url = url;
        }
...
$.fn.ajaxForm = function(settings) {
    ...
    var disableBtn = function() {formBtn.attr('disabled', 'disabled').removeClass('primary');};
    var enableBtn = function() {formBtn.removeAttr('disabled').addClass('primary');};
    if (settings.context) {
